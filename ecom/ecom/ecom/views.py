...
def home_view(request):
    # Fetch sorting parameter from the GET request
    sort_by = request.GET.get('sort_by', 'default')

    # Fetch products and sort them based on the parameter
    if sort_by == 'price_asc':
        ...
        products = models.Product.objects.all()  # Default order
    ...
    if request.user.is_authenticated:
        return redirect('afterlogin')  # Make sure 'afterlogin' is a valid URL name.

    # Fetch category data
    categories = Category.objects.all()

    # Render index.html with all necessary context
    return render(
        request,
        'ecom/index.html',
        {
...
def medicine(request):
    ...
    # Sorting logic
    sort_by = request.GET.get('sort_by', '')  # Sorting parameter from URL
    if sort_by == 'price_asc':
        ...
        products = products.order_by('-name')  # Sort by name descending

    # Pass the sorted products and categories to the template
    return render(request, 'ecom/medicine.html', {
        'products': products,
        'categories': categories,  # Fixed key name 'categories'
        'sort_by': sort_by,        # Pass sort_by for template retention
    })
...
def commodities(request):
    ...
    # Pass the sorted products and categories to the template
    return render(request, 'ecom/commodities.html', {
        'products': products,
        'categories': categories,  # Fixed key name 'categories'
        'sort_by': sort_by,        # Pass sort_by for template retention
    })
...
def Horticulture(request):
    ...
    # Pass the sorted products and categories to the template
    return render(request, 'ecom/Horticulture.html', {
        'products': products,
        'categories': categories,  # Fixed key name 'categories'
        'sort_by': sort_by,        # Pass sort_by for template retention
    })
...
def Spices(request):
    ...
    # Pass the sorted products and categories to the template
    return render(request, 'ecom/Spices.html', {
        'products': products,
        'categories': categories,  # Fixed key name 'categories'
        'sort_by': sort_by,        # Pass sort_by for template retention
    })
...
def Fruits(request):
    ...
    return render(request, 'ecom/Fruits.html', {
        'products': products,
        'categories': categories,
        'sort_by': sort_by,
    })
...
def Garments(request):
    ...
    return render(request, 'ecom/Garments.html', {
        'products': products,
        'categories': categories,
        'sort_by': sort_by,
    })
...
def DryFruits(request):
    ...
    return render(request, 'ecom/DryFruits.html', {
        'products': products,
        'categories': categories,
        'sort_by': sort_by,
    })
...
def Honey(request):
    ...
    return render(request, 'ecom/Honey.html', {
        'products': products,
        'categories': categories,
        'sort_by': sort_by,
    })
...
def search_view(request):
    ...
    if sort_by == 'price_asc':
        ...
        products = products.order_by('name')  # Ascending name
    elif sort_by == 'name_desc':
        products = products.order_by('-name')  # Descending name
    ...
    # Word to show on the frontend
    word = "Searched Result :"

    # Render the template with the appropriate products and other variables
    context = {
        'products': products,
        'word': word,
        'product_count_in_cart': product_count_in_cart,
        'query': query,  # Include the query for retaining it in the search box
    }
...
def customer_home_view(request):
    ...
    # Product count in cart from cookies
    if 'product_ids' in request.COOKIES:
        product_ids = request.COOKIES['product_ids']
        counter = product_ids.split('|')
        product_count_in_cart = len(set(counter))
